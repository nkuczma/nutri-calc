...
- [x] 1.1 TypeScript compilation passes: `npm run build` — 34206dd
- [x] 1.2 Linting passes: `npm run lint` — 34206dd
...
- [x] 3.1 TypeScript compilation passes: `npm run build` — de1c0a6
- [x] 3.2 Linting passes: `npm run lint` — de1c0a6
