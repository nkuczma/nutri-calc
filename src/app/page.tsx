      ...
      <main className="mx-auto max-w-xl px-4 py-16">
        ...
        {user ? (
          <div className="space-y-4">
            ...
            <Link
              href="/parse"
              className="inline-block rounded-md border border-zinc-300 px-4 py-2 text-sm font-medium text-zinc-900 hover:bg-zinc-50 dark:border-zinc-700 dark:text-zinc-100 dark:hover:bg-zinc-800"
            >
              Parse a recipe
            </Link>
            <form action={signOut}>
